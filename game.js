...
function Move(c){
      ...
      if(whose_move == 1){
        ...
        if(ok==1){
          ...
          alert("This square already occupied. Please select another one");
        }
      }else{
          if(whose_move == 2){
            check_space();
...
function check_win(){
  ...
  if((a!=0)&&(b!=0)&&(c!=0)&&(d!=0)&&(e!=0)&&(f!=0)&&(g!=0)&&(h!=0)&&(i!=0)) who_won=3;
}
...
function help(){
  alert("Welcome to Tic-Tac-Toe! Player1 plays the 0's and Player2 plays the X's. Select the sqaure you want by clicking them. Good Luck!");
}
